...
func (m *Propeller) Encode() []byte {
	...
	s[0] |= (byte(m.Id)) & 255
	s[1] |= (byte(m.Status)) & 3
	s[1] |= (byte(m.Direction) << 2) & 12
	return s
}

func (m *Propeller) Decode(s []byte) {
	m.Id |= uint8(byte(s[0]) & 255)
	m.Status |= PropellerStatus(byte(s[1]) & 3)
	m.Direction |= RotatingDirection(byte(s[1]>>2) & 3)
}
...
func (m *Power) Encode() []byte {
	s := make([]byte, 2)
	s[0] |= (byte(m.Battery)) & 255
	s[1] |= (byte(m.Status)) & 3
	s[1] |= (byte(bool2byte(m.IsCharging)) << 2) & 4
	return s
}

func (m *Power) Decode(s []byte) {
	m.Battery |= uint8(byte(s[0]) & 255)
	m.Status |= PowerStatus(byte(s[1]) & 3)
	m.IsCharging = byte2bool(byte(s[1]>>2) & 1)
}
...
func (m *Network) Encode() []byte {
	s := make([]byte, 9)
	s[0] |= (byte(m.Signal)) & 15
	s[0] |= (byte(m.HeartbeatAt) << 4) & 240
	s[1] |= (byte(m.HeartbeatAt) >> 4) & 15
	s[1] |= (byte(m.HeartbeatAt>>8) << 4) & 240
	s[2] |= (byte(m.HeartbeatAt>>8) >> 4) & 15
	s[2] |= (byte(m.HeartbeatAt>>16) << 4) & 240
	s[3] |= (byte(m.HeartbeatAt>>16) >> 4) & 15
	s[3] |= (byte(m.HeartbeatAt>>24) << 4) & 240
	s[4] |= (byte(m.HeartbeatAt>>24) >> 4) & 15
	s[4] |= (byte(m.HeartbeatAt>>32) << 4) & 240
	s[5] |= (byte(m.HeartbeatAt>>32) >> 4) & 15
	s[5] |= (byte(m.HeartbeatAt>>40) << 4) & 240
	s[6] |= (byte(m.HeartbeatAt>>40) >> 4) & 15
	s[6] |= (byte(m.HeartbeatAt>>48) << 4) & 240
	s[7] |= (byte(m.HeartbeatAt>>48) >> 4) & 15
	s[7] |= (byte(m.HeartbeatAt>>56) << 4) & 240
	s[8] |= (byte(m.HeartbeatAt>>56) >> 4) & 15
	return s
}

func (m *Network) Decode(s []byte) {
	m.Signal |= uint8(byte(s[0]) & 15)
	m.HeartbeatAt |= Timestamp(byte(s[0]>>4) & 15)
	m.HeartbeatAt |= Timestamp(byte(s[1]<<4) & 240)
	m.HeartbeatAt |= Timestamp(byte(s[1]>>4)&15) << 8
	m.HeartbeatAt |= Timestamp(byte(s[2]<<4)&240) << 8
	m.HeartbeatAt |= Timestamp(byte(s[2]>>4)&15) << 16
	m.HeartbeatAt |= Timestamp(byte(s[3]<<4)&240) << 16
	m.HeartbeatAt |= Timestamp(byte(s[3]>>4)&15) << 24
	m.HeartbeatAt |= Timestamp(byte(s[4]<<4)&240) << 24
	m.HeartbeatAt |= Timestamp(byte(s[4]>>4)&15) << 32
	m.HeartbeatAt |= Timestamp(byte(s[5]<<4)&240) << 32
	m.HeartbeatAt |= Timestamp(byte(s[5]>>4)&15) << 40
	m.HeartbeatAt |= Timestamp(byte(s[6]<<4)&240) << 40
	m.HeartbeatAt |= Timestamp(byte(s[6]>>4)&15) << 48
	m.HeartbeatAt |= Timestamp(byte(s[7]<<4)&240) << 48
	m.HeartbeatAt |= Timestamp(byte(s[7]>>4)&15) << 56
	m.HeartbeatAt |= Timestamp(byte(s[8]<<4)&240) << 56
}
...
func (m *LandingGear) Decode(s []byte) {
	m.Status |= LandingGearStatus(byte(s[0]) & 3)
}
...
func (m *Position) Encode() []byte {
	s := make([]byte, 12)
	s[0] |= (byte(m.Latitude)) & 255
	s[1] |= (byte(m.Latitude >> 8)) & 255
	s[2] |= (byte(m.Latitude >> 16)) & 255
	s[3] |= (byte(m.Latitude >> 24)) & 255
	s[4] |= (byte(m.Longitude)) & 255
	s[5] |= (byte(m.Longitude >> 8)) & 255
	s[6] |= (byte(m.Longitude >> 16)) & 255
	s[7] |= (byte(m.Longitude >> 24)) & 255
	s[8] |= (byte(m.Altitude)) & 255
	s[9] |= (byte(m.Altitude >> 8)) & 255
	s[10] |= (byte(m.Altitude >> 16)) & 255
	s[11] |= (byte(m.Altitude >> 24)) & 255
	return s
}

func (m *Position) Decode(s []byte) {
	m.Latitude |= uint32(byte(s[0]) & 255)
	m.Latitude |= uint32(byte(s[1])&255) << 8
	m.Latitude |= uint32(byte(s[2])&255) << 16
	m.Latitude |= uint32(byte(s[3])&255) << 24
	m.Longitude |= uint32(byte(s[4]) & 255)
	m.Longitude |= uint32(byte(s[5])&255) << 8
	m.Longitude |= uint32(byte(s[6])&255) << 16
	m.Longitude |= uint32(byte(s[7])&255) << 24
	m.Altitude |= uint32(byte(s[8]) & 255)
	m.Altitude |= uint32(byte(s[9])&255) << 8
	m.Altitude |= uint32(byte(s[10])&255) << 16
	m.Altitude |= uint32(byte(s[11])&255) << 24
}
...
func (m *Pose) Encode() []byte {
	s := make([]byte, 12)
	s[0] |= (byte(m.Yaw)) & 255
	s[1] |= (byte(m.Yaw >> 8)) & 255
	s[2] |= (byte(m.Yaw >> 16)) & 255
	s[3] |= (byte(m.Yaw >> 24)) & 255
	s[4] |= (byte(m.Pitch)) & 255
	s[5] |= (byte(m.Pitch >> 8)) & 255
	s[6] |= (byte(m.Pitch >> 16)) & 255
	s[7] |= (byte(m.Pitch >> 24)) & 255
	s[8] |= (byte(m.Roll)) & 255
	s[9] |= (byte(m.Roll >> 8)) & 255
	s[10] |= (byte(m.Roll >> 16)) & 255
	s[11] |= (byte(m.Roll >> 24)) & 255
	return s
}

func (m *Pose) Decode(s []byte) {
	m.Yaw |= int32(byte(s[0]) & 255)
	m.Yaw |= int32(byte(s[1])&255) << 8
	m.Yaw |= int32(byte(s[2])&255) << 16
	m.Yaw |= int32(byte(s[3])&255) << 24
	m.Pitch |= int32(byte(s[4]) & 255)
	m.Pitch |= int32(byte(s[5])&255) << 8
	m.Pitch |= int32(byte(s[6])&255) << 16
	m.Pitch |= int32(byte(s[7])&255) << 24
	m.Roll |= int32(byte(s[8]) & 255)
	m.Roll |= int32(byte(s[9])&255) << 8
	m.Roll |= int32(byte(s[10])&255) << 16
	m.Roll |= int32(byte(s[11])&255) << 24
}
...
func (m *Flight) Encode() []byte {
	s := make([]byte, 36)
	s[0] |= (byte(m.Pose.Yaw)) & 255
	s[1] |= (byte(m.Pose.Yaw >> 8)) & 255
	s[2] |= (byte(m.Pose.Yaw >> 16)) & 255
	s[3] |= (byte(m.Pose.Yaw >> 24)) & 255
	s[4] |= (byte(m.Pose.Pitch)) & 255
	s[5] |= (byte(m.Pose.Pitch >> 8)) & 255
	s[6] |= (byte(m.Pose.Pitch >> 16)) & 255
	s[7] |= (byte(m.Pose.Pitch >> 24)) & 255
	s[8] |= (byte(m.Pose.Roll)) & 255
	s[9] |= (byte(m.Pose.Roll >> 8)) & 255
	s[10] |= (byte(m.Pose.Roll >> 16)) & 255
	s[11] |= (byte(m.Pose.Roll >> 24)) & 255
	s[12] |= (byte(m.Velocity[0])) & 255
	s[13] |= (byte(m.Velocity[0] >> 8)) & 255
	s[14] |= (byte(m.Velocity[0] >> 16)) & 255
	s[15] |= (byte(m.Velocity[0] >> 24)) & 255
	s[16] |= (byte(m.Velocity[1])) & 255
	s[17] |= (byte(m.Velocity[1] >> 8)) & 255
	s[18] |= (byte(m.Velocity[1] >> 16)) & 255
	s[19] |= (byte(m.Velocity[1] >> 24)) & 255
	s[20] |= (byte(m.Velocity[2])) & 255
	s[21] |= (byte(m.Velocity[2] >> 8)) & 255
	s[22] |= (byte(m.Velocity[2] >> 16)) & 255
	s[23] |= (byte(m.Velocity[2] >> 24)) & 255
	s[24] |= (byte(m.Acceleration[0])) & 255
	s[25] |= (byte(m.Acceleration[0] >> 8)) & 255
	s[26] |= (byte(m.Acceleration[0] >> 16)) & 255
	s[27] |= (byte(m.Acceleration[0] >> 24)) & 255
	s[28] |= (byte(m.Acceleration[1])) & 255
	s[29] |= (byte(m.Acceleration[1] >> 8)) & 255
	s[30] |= (byte(m.Acceleration[1] >> 16)) & 255
	s[31] |= (byte(m.Acceleration[1] >> 24)) & 255
	s[32] |= (byte(m.Acceleration[2])) & 255
	s[33] |= (byte(m.Acceleration[2] >> 8)) & 255
	s[34] |= (byte(m.Acceleration[2] >> 16)) & 255
	s[35] |= (byte(m.Acceleration[2] >> 24)) & 255
	return s
}

func (m *Flight) Decode(s []byte) {
	m.Pose.Yaw |= int32(byte(s[0]) & 255)
	m.Pose.Yaw |= int32(byte(s[1])&255) << 8
	m.Pose.Yaw |= int32(byte(s[2])&255) << 16
	m.Pose.Yaw |= int32(byte(s[3])&255) << 24
	m.Pose.Pitch |= int32(byte(s[4]) & 255)
	m.Pose.Pitch |= int32(byte(s[5])&255) << 8
	m.Pose.Pitch |= int32(byte(s[6])&255) << 16
	m.Pose.Pitch |= int32(byte(s[7])&255) << 24
	m.Pose.Roll |= int32(byte(s[8]) & 255)
	m.Pose.Roll |= int32(byte(s[9])&255) << 8
	m.Pose.Roll |= int32(byte(s[10])&255) << 16
	m.Pose.Roll |= int32(byte(s[11])&255) << 24
	m.Velocity[0] |= int32(byte(s[12]) & 255)
	m.Velocity[0] |= int32(byte(s[13])&255) << 8
	m.Velocity[0] |= int32(byte(s[14])&255) << 16
	m.Velocity[0] |= int32(byte(s[15])&255) << 24
	m.Velocity[1] |= int32(byte(s[16]) & 255)
	m.Velocity[1] |= int32(byte(s[17])&255) << 8
	m.Velocity[1] |= int32(byte(s[18])&255) << 16
	m.Velocity[1] |= int32(byte(s[19])&255) << 24
	m.Velocity[2] |= int32(byte(s[20]) & 255)
	m.Velocity[2] |= int32(byte(s[21])&255) << 8
	m.Velocity[2] |= int32(byte(s[22])&255) << 16
	m.Velocity[2] |= int32(byte(s[23])&255) << 24
	m.Acceleration[0] |= int32(byte(s[24]) & 255)
	m.Acceleration[0] |= int32(byte(s[25])&255) << 8
	m.Acceleration[0] |= int32(byte(s[26])&255) << 16
	m.Acceleration[0] |= int32(byte(s[27])&255) << 24
	m.Acceleration[1] |= int32(byte(s[28]) & 255)
	m.Acceleration[1] |= int32(byte(s[29])&255) << 8
	m.Acceleration[1] |= int32(byte(s[30])&255) << 16
	m.Acceleration[1] |= int32(byte(s[31])&255) << 24
	m.Acceleration[2] |= int32(byte(s[32]) & 255)
	m.Acceleration[2] |= int32(byte(s[33])&255) << 8
	m.Acceleration[2] |= int32(byte(s[34])&255) << 16
	m.Acceleration[2] |= int32(byte(s[35])&255) << 24
}
